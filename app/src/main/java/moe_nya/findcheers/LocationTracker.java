...
import android.location.LocationListener; //这里在应用的时候要import location套装。import不同，implement的内容不一样就无法正确的compile
...
public class LocationTracker implements LocationListener {
    ...
    private static final int PERMISSIONS_REQUEST_LOCATION = 99;//99代表一种可以check permission的code
    private static final long MIN_DISTANCE_CHANGE_FOR_UPDATES = 10;// 这里的单位是mile，最小误差是这个数值
    private static final long MIN_TIME_BW_UPDATES = 1000 * 60;

    private boolean mIsGPSEnabled;//先对gps进行check之后再对network进行check
